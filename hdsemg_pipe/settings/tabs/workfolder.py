...
from hdsemg_pipe.ui_elements.theme import Styles, Colors, Spacing
...
def init_workfolder_widget(parent):
    ...
    workfolder_layout.setSpacing(Spacing.SM)

    # Label prompting for work folder path
    workfolder_label = QLabel("Work Folder Path:")
    workfolder_label.setStyleSheet(Styles.label_heading(size="sm"))
    ...
    workfolder_line_edit.setStyleSheet(Styles.input_field())
    ...
    def update_validity():
        ...
        if os.path.isdir(folder_path):
            ...
            validity_indicator.setStyleSheet(f"color: {Colors.GREEN_600}; font-size: 20px; font-weight: bold;")
        else:
            validity_indicator.setText("✕")
            validity_indicator.setStyleSheet(f"color: {Colors.RED_600}; font-size: 20px; font-weight: bold;")
