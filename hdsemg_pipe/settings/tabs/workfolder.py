...
def init_workfolder_widget(parent):
    ...
    workfolder_layout.setSpacing(8)
    ...
    def update_validity():
        ...
        if os.path.isdir(folder_path):
            ...
            validity_indicator.setStyleSheet("color: green; font-size: 20px; font-weight: bold;")
        else:
            validity_indicator.setText("✕")
            validity_indicator.setStyleSheet("color: red; font-size: 20px; font-weight: bold;")
