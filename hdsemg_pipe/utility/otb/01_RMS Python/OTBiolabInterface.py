            ...
            try:
                ...
                for track_info in tracks_infos:
                    ...
                    with open(os.path.join('tmpopen', sig_file_path), 'rb') as h:
                        ...
                        LSB=(adc_range / (pow(2,adc_nbits))* gain);#*unit_of_measurement_factor; do not include anymore, data are written in Volts and loaded with a factor later in otbiolab
